      ...
      <Card>
        ...
        <CardContent className="p-5">
          <form className="grid gap-5 lg:grid-cols-2">
            <Input label={{ en: "Workspace name", zh: "工作区名称" }} defaultValue="Saas Admin Jpa" />
            <Input label={{ en: "API base URL", zh: "API 基础地址" }} defaultValue="http://localhost:8080" />
            <Input containerClassName="lg:col-span-2" label={{ en: "Enabled modules", zh: "已启用模块" }} defaultValue="auth, rbac, audit-log" />
